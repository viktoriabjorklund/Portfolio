...
const Home = () => {
    ...
    return (
        ...
        <div class="flex flex-row">
            <div class='text-justify chonburi-regular-shadow text-[#DD5341] xl:w-[1500px] xl:text-4xl 2xl:text-5xl xl:ml-20 2xl:ml-24 xl: mt-26 2xl:mt-32'>
                    HELLO, I AM VIKTORIA!
                    <div class="text-left chonburi-regular text-[#DD5341] lg:text-xl xl:text-xl pb-48">
                    ...
                    of my current expertise through a selection of projects. 
                ...
                <div class="flex justify-end w-full mt-24 mr-48">
                    <img src="portfolio-bild.jpg" class="w-80 h-80 object-cover rounded-full" alt="Profile Picture"></img>
                    </div>
        </div>
                </div>
